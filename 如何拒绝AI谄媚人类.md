...
本文的贡献有三点。第一，给出“AI 谄媚”在开放式调研中的操作性定义：接受用户原始问题作为目标函数，并将回答优化为用户更容易接受的局部最优。第二，用约束优化、鲁棒优化、敏感性分析和贝叶斯更新解释如何抵抗这种局部最优。第三，给出可复用的调研流程、质量评估方法和局限性说明，使该方法能够落地到多轮调研工作流中。
